...
import binary from "../image/binary.svg"
...
const Home = () => {
  ...
  const wholeNumber = () => {
    return <redirect to="/whole-number" />;
  }
  ...
  return (
    <>
      <div>
        ...
        <section className="py-5 py-lg-7 first-section">
        ...
        <section className="py-5 py-lg-7 second-section" style={{ backgroundColor: "#e9ecef" }} id="binary">
          <Container>
            <Row className="d-flex align-items-center " >
              ...
              <Col xs={{ order: 'first' }} lg={{ span: 6, order: 'last' }} >
                <Row>
                  <div>
                    ...
                    <p>Converting a number from one base to another in number systems involves changing the representation of the number while preserving its value. The most common bases for number systems are decimal (base 10), binary (base 2), octal (base 8), and hexadecimal (base 16)</p>
                  </div>
                </Row>
                <Row>
                  <Col>
